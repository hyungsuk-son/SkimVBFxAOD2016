...
//  EL::GridDriver driver; //grid in the background
  ...
  driver.options()->setString("nc_outputSampleName", "user.hson.data15_13TeV.DAOD.03072017.%in:name[2]%.%in:name[6]%"); //For PrunDriver
...
//  driver.options()->setString("nc_excludedSite", "ANALY_INFN-NAPOLI-RECAS,ANALY_INFN-NAPOLI,ANALY_DESY-HH,ANALY_GRIF-IRFU,ANALY_AUSTRALIA,ANALY_SFU,ANALY_SCINET,ANALY_CPPM,ANALY_SiGNET,ANALY_LPC,ANALY_NSC,ANALY_CONNECT,ANALY_MWT2_SL6,ANALY_BU_ATLAS_Tier2_SL6,ANALY_wuppertalprod,ANALY_ARNES,ANALY_SLAC_SHORT_1HR,ANALY_SLAC,ANALY_RAL_SL6,ANALY_INFN-MILANO-ATLASC");
//
  //driver.options()->setString("nc_excludedSite", "ANALY_LRZ,ANALY_CPPM,ANALY_SiGNET,ANALY_FREIBURG,ANALY_RRC-KI-T1,ANALY_MCGILL,ANALY_LPC,ANALY_RHUL_SL6,ANALY_CSCS,ANALY_BNL_SHORT,ANALY_FZK_SHORT,ANALY_BU_ATLAS_Tier2_SL6,ANALY_GLASGOW_SL6,ANALY_GOEGRID,ANALY_INFN-NAPOLI-RECAS,ANALY_RAL_SL6,ANALY_SFU");
